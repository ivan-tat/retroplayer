...
function  sb_new: PSBDEV;
procedure sb_init(self: PSBDEV);
...
function  sb_mode_get_bits(self: PSBDEV): Byte;
function  sb_mode_is_signed(self: PSBDEV): Boolean;
function  sb_mode_get_channels(self: PSBDEV): Byte;
function  sb_mode_get_rate(self: PSBDEV): Word;
...
procedure sb_delete(var self: PSBDEV);
...
function  sb_new: PSBDEV; external;
procedure sb_init(self: PSBDEV); external;
...
function  sb_mode_get_bits(self: PSBDEV): Byte; external;
function  sb_mode_is_signed(self: PSBDEV): Boolean; external;
function  sb_mode_get_channels(self: PSBDEV): Byte; external;
function  sb_mode_get_rate(self: PSBDEV): Word; external;
...
procedure sb_delete(var self: PSBDEV); external;
