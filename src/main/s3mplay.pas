...
procedure player_find_next_pattern;
procedure player_set_song_loop;
procedure player_load_s3m;
procedure player_get_mixing_channels;
...
procedure player_find_next_pattern; external;
procedure player_set_song_loop; external;
procedure player_load_s3m; external;
procedure player_get_mixing_channels; external;
